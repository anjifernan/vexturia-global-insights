...
const allProperties = [
  { id: 1, title: "Ático de lujo con vistas panorámicas", type: "Ático", operation: "Compra", location: "Madrid, Salamanca", m2: 180, rooms: 3, baths: 2, price: 1250000, premium: true, image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&h=400&fit=crop" },
  { id: 2, title: "Piso reformado en el centro", type: "Piso", operation: "Compra", location: "Barcelona, Eixample", m2: 110, rooms: 2, baths: 1, price: 425000, premium: false, image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=400&fit=crop" },
  { id: 3, title: "Villa con piscina privada", type: "Casa", operation: "Compra", location: "Marbella, Golden Mile", m2: 320, rooms: 5, baths: 4, price: 2100000, premium: true, image: "https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=600&h=400&fit=crop" },
  ...
  { id: 5, title: "Loft industrial reformado", type: "Loft", operation: "Compra", location: "Madrid, Lavapiés", m2: 95, rooms: 1, baths: 1, price: 310000, premium: false, image: "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=600&h=400&fit=crop" },
  { id: 6, title: "Chalet adosado con jardín", type: "Casa", operation: "Compra", location: "Pozuelo de Alarcón", m2: 220, rooms: 4, baths: 3, price: 680000, premium: true, image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop" },
];
...
export default function Properties() {
  ...
  const filtered = useMemo(() => {
    return allProperties.filter((p) => {
      if (operacion && operacion !== "Operación" && p.operation !== operacion) return false;
      if (tipo && tipo !== "Tipo" && p.type !== tipo) return false;
      if (ubicacion && !p.location.toLowerCase().includes(ubicacion.toLowerCase())) return false;
      if (precioMax && p.price > Number(precioMax)) return false;
      return true;
    });
  }, [operacion, tipo, ubicacion, precioMax]);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-muted/50 rounded-xl p-6 mb-8 grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <input
              ...
              type="number"
            />
            <Button className="gap-2" onClick={() => {/* filters are reactive */}}>
          ...
          {filtered.length === 0 ? (
            <p className="text-center text-muted-foreground py-12">No se encontraron propiedades con los filtros seleccionados.</p>
          ) : (
